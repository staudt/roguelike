...
export const ROLES: RoleDef[] = [
  {
    ...
    baseSpeed: 150,
    baseWeight: 1.2,
    baseAttributes: { str: 16, dex: 10, con: 14, search: 6 },
    hpDie: 10,
  ...
  },
  {
    ...
    baseSpeed: 170,
    baseWeight: 0.9,
    baseAttributes: { str: 12, dex: 15, con: 10, search: 12 },
    hpDie: 6,
  ...
  },
  {
    id: 'caveman',
    name: 'Caveman',
    description: 'Primitive but unstoppable. Club first, questions never.',
    color: '#c4854c',
    baseHealth: 140,
    baseSpeed: 130,
    baseWeight: 1.5,
    baseAttributes: { str: 18, dex: 8, con: 16, search: 4 },
    hpDie: 12,
